...
export default function GuideLines({ user, setUser }) {
  ...
  return (
    <div className="p-5 body-store1 " style={{background:"linear-gradient(315deg, rgb(13 100 189) 0%, rgb(28 233 220) 100%) 100%"}}>
      <div
      ...
      >
        ...
        >
          ...
          >
            <button
              ...
              style={{ backgroundColor: "#ffe9da87",fontWeight:"600" }}
            >
          ...
          <div
            id="collapseOne"
            class="accordion-collapse collapse show text-white"
            data-bs-parent="#accordionExample"
            style={{ backgroundColor: "#0000006e",fontWeight:"600" }}
          >
            <div class="accordion-body">
              ...
              Period: October 16th, 2023 (10:00 am Eastern Time) – October 23rd,
              2023 (5:00 pm Eastern Time) (“Judging Period”). Winners Announced:
              On or around October 27th, 2023 (3:00 pm Eastern Time).
            </div>
          </div>
        </div>
        <div
        ...
        >
          ...
          >
            <div class="accordion-body">
              Entrants must create a (or update an existing) software prototype
              or application that uses Dropbox Sign API and any publicly
              available AI technology to revolutionize how agreements get
              signed.
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            <div class="accordion-body">
              The Hackathon IS open to: Individuals who are at least the age of
              18 at the time of entry (“Eligible Individuals”); Teams of
              ...
              “Entrants”) An Eligible Individual may join more than one Team or
              Organization and an Eligible Individual who is part of a Team or
              Organization may also enter the Hackathon on an individual basis.
              If a Team or Organization is entering the Hackathon, they must
              appoint and authorize one individual (the “Representative”) to
              represent, act, and enter a Submission (defined below), on their
              behalf. By entering a Submission on behalf of a Team or
          ...
          >
            <div class="accordion-body">
              ...
              <p>
                ...
                clicking the “Join Hackathon” button. To complete registration,
                sign up to create a free Devpost account, or log in with an
                existing Devpost account. This will enable you to receive
                important updates and to create your Submission.
              </p>
              <p>
                {" "}
                ...
                operating and publicizing the Hackathon.
              </p>
              <p>
              ...
              <p>
                ...
                Sponsor, that Sponsor can use to improve the Dropbox Sign API or
                related documentation (for example, bug reports, user interface
                improvements, suggested integrations, and more). Each Entrant
                may submit only one (1) Feedback Submission.
              </p>
              <p>
