...
const JudgeReview = ({alert}) => {
  ...
  useEffect(() => {
    axios({
      method: "get",
      url: "https://lb0y9x24b9.execute-api.us-east-1.amazonaws.com/api/implementations/" + `${param.id}`,
      headers: {
  ...
  const submit = () => {
    ...
    axios({
      method: "post",
      url: "https://lb0y9x24b9.execute-api.us-east-1.amazonaws.com/api/implementations/addScores",
      data: { 
