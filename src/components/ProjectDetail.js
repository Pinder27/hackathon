...
const ProjectDetail = () => {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(315deg, rgb(13 100 189) 0%, rgb(28 233 220) 100%) 100%",
      }}
    >
      <h2 className="mb-5 mt-3 text-center">Hackathon 2023</h2>
      {loader2?(<div class="text-center">
  <div class="spinner-border" role="status">
    <span class="visually-hidden">Loading...</span>
        ...
        <div className="col">
          ...
          <div className="h5 text-center pt-2 mb-3 mt-5">{idea.teamName}</div>
